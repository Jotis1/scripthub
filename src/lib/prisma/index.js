...
const config = {
	generator: {
		...
		output: {
			value: "D:\\Development\\Jotis\\scripthub\\src\\lib\\prisma",
			fromEnvVar: null,
		},
		config: {
			engineType: "library",
		...
		previewFeatures: [],
		sourceFilePath:
			"D:\\Development\\Jotis\\scripthub\\prisma\\schema.prisma",
		isCustomOutput: true,
	},
	relativeEnvPaths: {
		rootEnvPath: null,
	...
	inlineSchemaHash:
		"daa40ee86e244fc959bd39ab158a1bc23bcefb4eb01e351e0a581d9d843b8a91",
	copyEngine: true,
};
...
if (!fs.existsSync(path.join(__dirname, "schema.prisma"))) {
	const alternativePaths = ["src/lib/prisma", "lib/prisma"];
