	...
	Ls.exports = (function () {
		...
		return function (t, r) {
			...
			var a = 0,
				...
				me = [];
			for (f = 0; f < i; f++)
				me.push(f + 1), me.push(t.charCodeAt(s + f));
...
function Ki(e, t, r, n) {
	...
	if (Array.isArray(e)) {
		let i = e;
		return (
			n && (i = i.filter((o) => o !== null)), i.map((o) => rl(o, t, r))
		);
	}
	...
	async interpretNode(t, r, n, i) {
		switch (t.type) {
			...
			case "validate": {
				...
				return (
					uc(o, t.args.rules, t.args), { value: o, lastInsertId: s }
				);
			}
			case "if": {
			...
			case "diff": {
				...
				return {
					value: vo(o).filter((f) => !a.has(JSON.stringify(f))),
				};
			}
			case "process": {
				let { value: o, lastInsertId: s } = await this.interpretNode(
			...
			return (
				Co === void 0 &&
					(Co = (async () => {
						...
						return (
							n.__wbg_set_wasm(s.exports), a(), n.QueryCompiler
						);
					})()),
				await Co
			);
