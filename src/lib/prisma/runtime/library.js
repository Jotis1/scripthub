...
function $p(e, r) {
	...
	return (
		!e.s || !r.s
			? (t = new this(NaN))
			: !e.d && !r.d
				? ((t = xe(this, o, 1).times(r.s > 0 ? 0.25 : 0.75)),
					(t.s = e.s))
				: !r.d || e.isZero()
					? ((t = r.s < 0 ? xe(this, n, i) : new this(0)),
						(t.s = e.s))
					: !e.d || r.isZero()
...
function Zs(e) {
	...
	function i(o) {
		...
		if (l === "bigint")
			return (
				o < 0 ? ((o = -o), (u.s = -1)) : (u.s = 1), fn(u, o.toString())
			);
		throw Error(He + o);
	}
	if (
...
You may have to run ${qe("prisma generate")} for your changes to take effect.`,
	...
	async stop() {
		if (
			...
			return (
				Re("library is already stopping"), this.libraryStoppingPromise
			);
...
${a.backtrace}`,
	...
	getExternalAdapterError(r, t) {
		if (r.error_code === wf && t) {
			...
			return (
				an(i, "External error with reported id was not registered"), i
			);
		}
	}
	async metrics(r) {
