	...
	xn = ie(() => {
		...
		S.toPrecision = function (t, e) {
			...
			return (
				t === void 0
					? ((r = j(i)),
						(n = De(i, r <= o.toExpNeg || r >= o.toExpPos)))
					: (ce(t, 1, Ue),
						e === void 0 ? (e = o.rounding) : ce(e, 0, 8),
						(i = L(new o(i), t, e)),
						(r = j(i)),
...
${a.backtrace}`,
	...
	getExternalAdapterError(e, r) {
		if (e.error_code === Ol && r) {
			...
			return (
				Bt(i, "External error with reported id was not registered"), i
			);
		}
	}
	async metrics(e) {
